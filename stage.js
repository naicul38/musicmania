(function() {
    ...
    function updateCameraButton() {
        const btnText = elements.cameraBtn.querySelector('.stage-btn__label');
        btnText.textContent = state.isCameraEnabled ? 'Disable Camera' : 'Enable Camera';
        elements.cameraBtn.classList.toggle('is-on', state.isCameraEnabled);
    }
